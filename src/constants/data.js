...
export const downloadArtifacts = {
  extension: {
    ...
    version: 'v1.6.0',
    href: './downloads/studyflow-extension-v1.6.0.zip',
    action: 'download',
    buttonLabel: 'Download Extension',
    helper: 'Manual install package for Chrome and Edge',
    fileName: 'studyflow-extension-v1.6.0.zip',
  ...
  desktop_windows: {
    ...
    shortLabel: 'Windows',
    version: 'v1.7.0',
    href: './downloads/studyflow-desktop-v1.7.0.exe',
    action: 'download',
    buttonLabel: 'Download for Windows',
    helper: 'Native desktop app with system tray, notifications, and global hotkeys',
    fileName: 'studyflow-desktop-v1.7.0.exe',
    platform: 'Windows',
  },
  desktop_mac: {
    id: 'desktop_mac',
    ...
    shortLabel: 'macOS',
    version: 'v1.7.0',
    href: './downloads/studyflow-desktop-v1.7.0.dmg',
    action: 'download',
    buttonLabel: 'Download for macOS',
    helper: 'Native desktop app with system tray, notifications, and global hotkeys',
    fileName: 'studyflow-desktop-v1.7.0.dmg',
    platform: 'macOS',
  },
}
...
export const platformCards = [
  ...
  },
  {
    ...
    description: 'Native desktop app for Windows and macOS with system tray, native notifications, and global hotkeys for timer control.',
  },
]
